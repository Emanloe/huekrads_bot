...
HUEGRYZ_CHANCE = 0.03  # 3% после успешного подбора предмета
HUECRAB_EVENT_CHANCE = 0.05  # почасовая проверка, как у гиперборейского события
HUECRAB_EVENT_DAILY_LIMIT = 5
HUECRAB_TAME_CHANCE = 0.50
